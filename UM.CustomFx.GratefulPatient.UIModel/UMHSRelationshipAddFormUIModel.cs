...
namespace UM.CustomFx.GratefulPatient.UIModel
{
    ...
    public partial class UMHSRelationshipAddFormUIModel
    {

        private void UMHSRelationshipAddFormUIModel_Loaded(object sender, Blackbaud.AppFx.UIModeling.Core.LoadedEventArgs e)
        {
        ...
        {
            this.RECIPROCALTYPECODEID.Caption = string.Format("{0} is the ", this.RECIPROCALUMHSID.SearchDisplayText);
        ...
        private void RefreshAdditionalRelationships()
        {
           ...
           // }
            //else
            {
                guid1 = this.RECIPROCALUMHSID.Value;
        ...
        partial void OnCreated()
            {
                this.Loaded += UMHSRelationshipAddFormUIModel_Loaded;
                this.RECIPROCALUMHSID.ValueChanged += RECIPROCALUMHSID_ValueChanged;
            this.RELATIONSHIPTYPECODEID.ValueChanged += _relationshiptypecodeid_ValueChanged;
            this.RECIPROCALTYPECODEID.ValueChanged += _reciprocaltypecodeid_ValueChanged;
            //this.RELATIONSHIPCONSTITUENTNAME.Enabled = false;
            //this.RECIPROCALCONSTITUENTNAME.Enabled = false;
        }
